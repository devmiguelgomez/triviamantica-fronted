...
const ChatPrompt = () => {
  ...
  const loadConversationHistory = async (id) => {
    ...
    try {
      ...
      const res = await axios.get(`https://triviamantica-backend.vercel.app/api/chat/history?sessionId=${id}`);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await axios.post('https://triviamantica-backend.vercel.app/api/chat', { 
        prompt,
        sessionId 
      })
